...
ActiveRecord::Schema.define(version: 2021_03_05_204734) do
  ...
  create_table "garbage_containers", force: :cascade do |t|
    t.string "name"
    t.decimal "weight"
    t.bigint "user_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_garbage_containers_on_user_id"
  end
